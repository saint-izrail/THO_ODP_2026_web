...
const inputCls =
  "w-full rounded-xl border bg-surface-2 py-3.5 pl-12 pr-4 text-base text-ink outline-none transition-all placeholder:text-muted focus:bg-surface-3 focus:ring-4 focus:ring-primary/20";
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="group relative">
          ...
          <input
            ...
            className={`${inputCls} ${opts?.rightSlot ? "pr-12" : ""} ${err ? "border-danger/60 focus:border-danger" : "border-edge-strong hover:border-primary/40 focus:border-primary-dark"} disabled:opacity-60`}
            {...props}
          />
          {opts?.rightSlot}
        </div>
