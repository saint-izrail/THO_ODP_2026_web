    ...
    <>
      ...
      {loading ? (
        <div role="status" aria-busy="true" className="grid grid-cols-1 gap-6 md:grid-cols-12">
          ...
          <div className="h-[300px] animate-pulse rounded-2xl bg-white/60 motion-reduce:animate-none md:col-span-8" />
          <div className="h-[300px] animate-pulse rounded-2xl bg-white/60 motion-reduce:animate-none md:col-span-4" />
        </div>
      ) : loadError ? (
        ...
        <div role="alert" className="rounded-2xl border border-danger/20 bg-danger/5 p-10 text-center">
          ...
          <button
            ...
            className="mt-6 rounded-xl bg-primary-dark px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-primary-deep active:scale-[0.98]"
          >
            Muat Ulang
          </button>
        </div>
        ...
        <div className="rounded-2xl border border-white/60 bg-white/75 p-10 text-center shadow-[0_8px_32px_0_rgba(0,79,76,0.06)] backdrop-blur-xl">
          ...
          <button type="button" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-primary-dark px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/25 transition-all hover:bg-primary-deep active:scale-[0.98]">
            Buka Rekening Baru
        ...
        <>
          ...
          <section aria-labelledby="ringkasan-heading">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-12">
              {/* Kartu saldo */}
              <div className="relative flex min-h-[300px] flex-col justify-between overflow-hidden rounded-2xl border border-white/60 bg-white/75 p-8 shadow-[0_8px_32px_0_rgba(0,79,76,0.06)] backdrop-blur-xl md:col-span-8 md:p-10">
                ...
                <div className="relative z-10 mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                  <button type="button" className="flex items-center gap-2 rounded-xl bg-primary-dark px-8 py-3 text-sm font-semibold text-white shadow-lg shadow-primary/20 transition-all hover:bg-primary-deep active:scale-95">
                    Setor Sekarang
                    <IconArrowRight className="h-4 w-4" />
                  </button>
              ...
              {/* Kartu estimasi */}
              <div className="relative flex min-h-[300px] flex-col items-center justify-center overflow-hidden rounded-2xl border border-white/60 bg-gradient-to-br from-white to-[#eef5f4] p-8 text-center shadow-[0_8px_32px_0_rgba(0,79,76,0.06)] backdrop-blur-xl md:col-span-4">
          ...
          <section className="mt-20">
            ...
            <div className="rounded-2xl border border-white/60 bg-white/75 p-8 shadow-[0_8px_32px_0_rgba(0,79,76,0.06)] backdrop-blur-xl">
              ...
              <div
                className="relative mb-8 h-3 w-full overflow-hidden rounded-full bg-line/50"
                role="progressbar"
                aria-valuenow={pct}
                aria-valuemin={0}
                aria-valuemax={100}
              ...
              >
                <div
                  ...
                  style={{ width: `${pct}%` }}
                >
                  <div aria-hidden className="absolute inset-0 -translate-x-full animate-[shimmer_2.2s_infinite] bg-gradient-to-r from-transparent via-white/30 to-transparent motion-reduce:animate-none" />
                </div>
              </div>

              {/* Stepper 3 tahap */}
              <div className="relative grid grid-cols-3 gap-4 text-center">
                <div aria-hidden className="absolute left-[16%] right-[16%] top-4 -z-10 h-0.5 bg-line" />
                <div aria-hidden className="absolute left-[16%] top-4 -z-10 h-0.5 bg-secondary" style={{ right: pct >= 100 ? "16%" : "50%" }} />
                <div className="flex flex-col items-center">
                  <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-primary-dark text-white shadow-md shadow-primary/20">
                    <IconCheck className="h-4 w-4" />
                  </div>
                  <span className="text-xs font-medium text-primary-deep">Daftar Porsi</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full border-2 border-secondary bg-white">
                ...
                <div className={"flex flex-col items-center " + (pct >= 100 ? "" : "opacity-50")}>
                  <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-line/50 text-muted">
          ...
          {QUICK_SERVICES.map((svc) => {
            ...
            return (
              <button
                ...
                type="button"
                className={
                  "group flex flex-col items-center gap-4 rounded-xl border bg-white/75 p-6 text-center shadow-[0_8px_32px_0_rgba(0,79,76,0.04)] backdrop-blur-xl transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5 " +
                  (svc.dashed ? "border-dashed border-line" : "border-white/60")
                }
              >
                <span
                  aria-hidden
                  className={
                    ...
                    (svc.dashed
                      ...
                      : "bg-primary/5 text-primary group-hover:bg-primary-dark group-hover:text-white")
                  }
                >
